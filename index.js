...
//Event listeners to show the modal and hide it
...
//When clicking on any choice, set currentChoice and display the new screen
function choicesListerners() {
  ...
  spock.addEventListener("click", function () {
    const spockChoice = document.querySelector(".spock-choice");
    screen1.style.display = "none";
    screen2.style.display = "block";
    spockChoice.style.display = "block";
    userChoice = "spock";
    showHouseChoice();
  });

  lizzard.addEventListener("click", function () {
    const lizzardChoice = document.querySelector(".lizzard-choice");
    screen1.style.display = "none";
    screen2.style.display = "block";
    lizzardChoice.style.display = "block";
    userChoice = "lizzard";
    showHouseChoice();
  });
}

//Set timer to show random house choice
function showHouseChoice() {
  const options = ["rock", "paper", "scissors", "spock", "lizzard"];
  //Get random options item
  const randomOption = options[Math.floor(Math.random() * options.length)];
  const houseChoiceItem = document.querySelector(".house-choice-item");

  //Function to return the house choice
  ...
  //Timer
  setTimeout(function () {
    houseChoiceItem.classList.add("choice");
    houseChoiceItem.classList.add(`${randomOption}-choice`);
    houseChoiceItem.style.height = "100%";
    houseChoiceItem.style.width = "100%";
    houseChoiceItem.style.alignItems = "center";
    houseChoiceItem.style.justifyContent = "center";
    houseChoiceItem.innerHTML = houseChoice(randomOption);
    houseChoiceItem.style.display = "flex";
    checkWinner();
